        ...
        <Card bordered={false}>
          <div className={styles.tableList}>
            ...
            <div className={styles.tableListOperator}>
              <PButton icon="plus" type="primary" code="add" onClick={() => this.onAddClick()}>
                新增优惠券
              </PButton>
              {selectedRows.length === 1 && [
                ...
                selectedRows[0].status === 3 && selectedRows[0].publish_status === 1 && (
                  <PButton
                    key="publish"
                    code="publish"
                    onClick={() => this.onItemPublishClick(selectedRows[0])}
                  >
                    上架
                  </PButton>
                ),
                selectedRows[0].publish_status === 2 && (
                  <PButton
                    key="down"
                    code="down"
                    onClick={() => this.onItemDownClick(selectedRows[0])}
                  >
                    下架
                  </PButton>
                ),
