...
class WYFYJFChart extends React.Component {
  state = {
    data: [
      {
        month: '01',
  ...
  componentDidMount() {
    getMockData('b_park_income_analyse_proprerty').then(data => {
      let list = data || [];
      list = list.map(v => {
        return {
          ...v,
  ...
  render() {
    ...
    dv.transform({
      type: 'fold',
      fields: ['17应交', '17实缴', '18应交', '18实缴', '19应交', '19实缴'],
      key: 'sr', // key字段
      value: 'srtj', // value字段
    });
