...
import { advertisCreateSelect } from '../../services/advertisCreativeGroupServices';

export default class AdvertiserCreateSelect extends PureComponent {
  static defaultProps = {
    style: {},
    onChange: () => {},
  };
  ...
  fetch = name => {
    advertisCreateSelect({ id: this.props.parentID, name }).then(data => {
      if (data) {
